...
@memory = common dso_local global [1024 x i8] zeroinitializer, align 1
...
entry:
  ...
  store i8 0, i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @memory, i32 0, i32 0), align 1, !dbg !12
  store i32 0, i32* @cfi_trigger_count, align 4, !dbg !13
  store i32 0, i32* @dfi_trigger_count, align 4, !dbg !14
  store i32* bitcast (i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @memory, i32 0, i32 500) to i32*), i32** @global_ebp, align 4, !dbg !15
  store i32* bitcast (i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @memory, i32 0, i32 504) to i32*), i32** @global_esp, align 4, !dbg !16
...
entry:
  ...
  store i32 ptrtoint (i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @memory, i32 0, i32 1000) to i32), i32* %1, align 4, !dbg !28
  ...
  store i32 ptrtoint ([1024 x i8]* @memory to i32), i32* %2, align 4, !dbg !32
...
!1 = !DIFile(filename: "Core/Src/config.c", directory: "/home/fdl/Desktop/llvm_build_source/test_apps/light-controller/NonSecure")
!2 = !{}
...
!9 = !DIFile(filename: "./Core/Src/config.c", directory: "/home/fdl/Desktop/llvm_build_source/test_apps/light-controller/NonSecure")
