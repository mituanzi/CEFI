...
@.str.6 = private unnamed_addr constant [38 x i8] c"%s (char *output = %s, int len = %d)\0A\00", align 1
@__func__.Serial_write = private unnamed_addr constant [13 x i8] c"Serial_write\00", align 1
@.str.7 = private unnamed_addr constant [18 x i8] c"read from pin %d\0A\00", align 1
@.str.8 = private unnamed_addr constant [44 x i8] c"%s (char *operation = %s, int value = %d)\0D\0A\00", align 1
@__func__.analogWrite = private unnamed_addr constant [12 x i8] c"analogWrite\00", align 1
...
entry:
  ...
  %string = alloca [60 x i8], align 1
  store i8* %output, i8** %output.addr, align 4
  store i32 %len, i32* %len.addr, align 4
  %0 = bitcast [60 x i8]* %string to i8*, !dbg !62
  call void @llvm.memset.p0i8.i32(i8* align 1 %0, i8 0, i32 60, i1 false), !dbg !62
  %arraydecay = getelementptr inbounds [60 x i8], [60 x i8]* %string, i32 0, i32 0, !dbg !63
  %1 = load i8*, i8** %output.addr, align 4, !dbg !64
  %2 = load i32, i32* %len.addr, align 4, !dbg !65
  %call = call arm_aapcs_vfpcc i32 (i8*, i8*, ...) @sprintf(i8* %arraydecay, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__func__.Serial_write, i32 0, i32 0), i8* %1, i32 %2), !dbg !66
  %arraydecay1 = getelementptr inbounds [60 x i8], [60 x i8]* %string, i32 0, i32 0, !dbg !67
  call arm_aapcs_vfpcc void @print(i8* %arraydecay1, i32 60), !dbg !68
  ret i32 0, !dbg !69
}

; Function Attrs: noinline nounwind optnone
define dso_local arm_aapcs_vfpcc i32 @analogRead(i32 %pin) #0 !dbg !70 {
entry:
  %pin.addr = alloca i32, align 4
  %val = alloca i32, align 4
  store i32 %pin, i32* %pin.addr, align 4
  %0 = load i32, i32* %pin.addr, align 4, !dbg !71
  %call = call arm_aapcs_vfpcc i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i32 0, i32 0), i32 %0), !dbg !72
  %call1 = call arm_aapcs_vfpcc i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %val), !dbg !73
  %1 = load i32, i32* %val, align 4, !dbg !74
  ret i32 %1, !dbg !75
}
...
; Function Attrs: noinline nounwind optnone
define dso_local arm_aapcs_vfpcc void @analogWrite(i8* %operation, i32 %value) #0 !dbg !76 {
entry:
  %operation.addr = alloca i8*, align 4
  %value.addr = alloca i32, align 4
  %string = alloca [80 x i8], align 1
  store i8* %operation, i8** %operation.addr, align 4
  store i32 %value, i32* %value.addr, align 4
  %0 = bitcast [80 x i8]* %string to i8*, !dbg !77
  call void @llvm.memset.p0i8.i32(i8* align 1 %0, i8 0, i32 80, i1 false), !dbg !77
  %arraydecay = getelementptr inbounds [80 x i8], [80 x i8]* %string, i32 0, i32 0, !dbg !78
  %1 = load i8*, i8** %operation.addr, align 4, !dbg !79
  %2 = load i32, i32* %value.addr, align 4, !dbg !80
  %call = call arm_aapcs_vfpcc i32 (i8*, i8*, ...) @sprintf(i8* %arraydecay, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__func__.analogWrite, i32 0, i32 0), i8* %1, i32 %2), !dbg !81
  %arraydecay1 = getelementptr inbounds [80 x i8], [80 x i8]* %string, i32 0, i32 0, !dbg !82
  call arm_aapcs_vfpcc void @print(i8* %arraydecay1, i32 80), !dbg !83
  ret void, !dbg !84
}

; Function Attrs: noinline nounwind optnone
define dso_local arm_aapcs_vfpcc i32 @millis() #0 !dbg !85 {
entry:
  %start = alloca i32, align 4
  %call = call arm_aapcs_vfpcc i32 @HAL_GetTick(), !dbg !86
  store i32 %call, i32* %start, align 4, !dbg !87
  %0 = load i32, i32* %start, align 4, !dbg !88
  ret i32 %0, !dbg !89
}
...
; Function Attrs: noinline nounwind optnone
define dso_local arm_aapcs_vfpcc void @delayMicroseconds(float %usecs) #0 !dbg !90 {
entry:
  %usecs.addr = alloca float, align 4
  store float %usecs, float* %usecs.addr, align 4
  %0 = load float, float* %usecs.addr, align 4, !dbg !91
  %conv = fptoui float %0 to i32, !dbg !91
  call arm_aapcs_vfpcc void @HAL_Delay(i32 %conv), !dbg !92
  ret void, !dbg !93
}
...
; Function Attrs: noinline nounwind optnone
define dso_local arm_aapcs_vfpcc i32 @toUInt(i8* %input, i32 %len) #0 !dbg !94 {
entry:
  ...
  store i32 %len, i32* %len.addr, align 4
  %0 = load i8*, i8** %input.addr, align 4, !dbg !95
  %call = call arm_aapcs_vfpcc i32 @atoi(i8* %0), !dbg !96
  store i32 %call, i32* %val, align 4, !dbg !97
  %1 = load i32, i32* %val, align 4, !dbg !98
  ret i32 %1, !dbg !99
}
...
!1 = !DIFile(filename: "Core/Src/util.c", directory: "/home/fdl/Desktop/llvm_build_source/test_apps/steering_control/NonSecure")
!2 = !{}
...
!9 = !DIFile(filename: "./Core/Src/util.c", directory: "/home/fdl/Desktop/llvm_build_source/test_apps/steering_control/NonSecure")
...
!62 = !DILocation(line: 76, column: 16, scope: !61)
!63 = !DILocation(line: 77, column: 10, scope: !61)
!64 = !DILocation(line: 77, column: 70, scope: !61)
!65 = !DILocation(line: 77, column: 78, scope: !61)
!66 = !DILocation(line: 77, column: 2, scope: !61)
!67 = !DILocation(line: 78, column: 8, scope: !61)
!68 = !DILocation(line: 78, column: 2, scope: !61)
!69 = !DILocation(line: 80, column: 2, scope: !61)
!70 = distinct !DISubprogram(name: "analogRead", scope: !9, file: !9, line: 83, type: !10, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!71 = !DILocation(line: 85, column: 31, scope: !70)
!72 = !DILocation(line: 85, column: 2, scope: !70)
!73 = !DILocation(line: 86, column: 2, scope: !70)
!74 = !DILocation(line: 87, column: 9, scope: !70)
!75 = !DILocation(line: 87, column: 2, scope: !70)
!76 = distinct !DISubprogram(name: "analogWrite", scope: !9, file: !9, line: 90, type: !10, scopeLine: 90, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!77 = !DILocation(line: 92, column: 16, scope: !76)
!78 = !DILocation(line: 93, column: 10, scope: !76)
!79 = !DILocation(line: 93, column: 77, scope: !76)
!80 = !DILocation(line: 93, column: 88, scope: !76)
!81 = !DILocation(line: 93, column: 2, scope: !76)
!82 = !DILocation(line: 94, column: 8, scope: !76)
!83 = !DILocation(line: 94, column: 2, scope: !76)
!84 = !DILocation(line: 95, column: 1, scope: !76)
!85 = distinct !DISubprogram(name: "millis", scope: !9, file: !9, line: 97, type: !10, scopeLine: 97, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!86 = !DILocation(line: 100, column: 10, scope: !85)
!87 = !DILocation(line: 100, column: 8, scope: !85)
!88 = !DILocation(line: 102, column: 9, scope: !85)
!89 = !DILocation(line: 102, column: 2, scope: !85)
!90 = distinct !DISubprogram(name: "delayMicroseconds", scope: !9, file: !9, line: 115, type: !10, scopeLine: 115, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!91 = !DILocation(line: 117, column: 12, scope: !90)
!92 = !DILocation(line: 117, column: 2, scope: !90)
!93 = !DILocation(line: 118, column: 1, scope: !90)
!94 = distinct !DISubprogram(name: "toUInt", scope: !9, file: !9, line: 120, type: !10, scopeLine: 120, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!95 = !DILocation(line: 122, column: 13, scope: !94)
!96 = !DILocation(line: 122, column: 8, scope: !94)
!97 = !DILocation(line: 122, column: 6, scope: !94)
!98 = !DILocation(line: 123, column: 9, scope: !94)
!99 = !DILocation(line: 123, column: 2, scope: !94)
